...
INSERT INTO exercise1.students (roll_no, first_name, last_name, department, email, dob, age, course_id, score)
VALUES (1, 'ammu', 'easwaran', 'mechanical', 'ammu@gmail.com', '2001-05-04', 19, 2, 99);

INSERT INTO exercise1.students (roll_no, first_name, last_name, email, dob, age, course_id, score)
VALUES (2, 'amirtha', 'easwaran', 'amirtha@gmail.com', '2001-05-04', 19, 2, 85);

INSERT INTO exercise1.students (roll_no, first_name, department, email, dob, age, course_id, score)
...
INSERT INTO exercise1.courses (id, course_name, min_score)
